 ...
 * 3. 값들을 저장할 때마다 인덱스는 자동으로 증가 - 배열과 다르게 저장용량이 자동으로 증가
...
public class ListMain01 {
	public static void main(String[] args) {
		...
		// ArrayList <저장할 원소 타입> 변수 이름 = new ArrayList<>();
