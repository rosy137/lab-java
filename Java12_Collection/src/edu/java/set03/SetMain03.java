...
public class SetMain03 {
	...
	public static void main(String[] args) {
		...
		// Scroe 타입을 원소로 갖는 HashSet 변수 선언, 초기화
...
//		System.out.println(score1);
		...
		System.out.println("같나 " + score1.equals(score2));
		scores.add(score2);

		Score score3 = new Score(100,100,100);
		System.out.println("같나 " + score1.equals(score3));
		scores.add(score3);
		
		//-> (1) equals만 override를 하고 hashCode를 override 하지 않으면 score3이 Set에 추가됨.
