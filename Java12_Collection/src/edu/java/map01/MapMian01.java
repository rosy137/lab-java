 ...
 * Set: 인덱스 없음. 중복된 값을 저장할 수 없음. Hash-equal이면 저장 안함 
 * 
 * Map<K, V>
...
public class MapMian01 {
	...
	public static void main(String[] args) {
		...
		System.out.println(students.getOrDefault(10, "무명씨"));// value null > default return
		...
		students.put(3, "KIM DO HYUN");
		System.out.println(students.get(3));
		
		// Maps에서 향상된 for 문장을 사용하는 방법:
