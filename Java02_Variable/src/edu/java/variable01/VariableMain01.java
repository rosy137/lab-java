package edu.java.variable01; // 패키지 선언문
...
public class VariableMain01 {
	...
	public static void main(String[] args) {
		...
		int x; // (1) 변수_타입 변수_이름; x는 정수를 저장하는 변수
		x = 100; // (2) 변수_이름 = 값; 100이라는 값을 x라는 변수에 저장
