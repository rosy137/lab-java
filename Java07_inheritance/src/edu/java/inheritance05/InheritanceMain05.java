...
// final 클래스: 확장할 수 없는 크래스. 상속할 수 없는 클래스.
...
//	public void test2() {} // Cannot override the final method from A //-> final 변경할 수 없음, 재정의 불가능함.
}

// class MyString extends String {} // The type MyString cannot subclass the final class String
