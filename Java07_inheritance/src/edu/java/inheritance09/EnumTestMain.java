...
enum Time {
	...
	// constructor - enum 생성자 반드시 private
...
public class EnumTestMain {
	...
	public static void main(String[] args) {
		...
		System.out.println(t.toString()); // Enum 클래스에서 상속받은 메서드
		System.out.println(t.name()); // "
		System.out.println(t.ordinal()); //  " override 안되는 final method // 자리값 출력
		t = Time.PM;
