 ...
 * 		Reader
 * 		|__ InputStreamReader, BufferdReader
 * 			|__ FileReader
 * 		Writer
 ...
 * InputStreanReader, OutputStreamWriter가 인코딩 설정 기능을 가지고 있었음.
 * Java 11 이후 버전부터는 FileReader와 FileWriter에서도 인코딩을 설정할 수 있게 업데이트 됨.
 * 
 * 
 * 인코딩(encoding): 문자에 해당하는 코드(정수)로 변환. (예) 'A' -> 65
 * 디코딩(decoding): 문자 코드(정수)에 해당하는 문자로 변환. (예) 64 -> 'A'
...
public class FileMain08 {
	...
	public static void main(String[] args) {
		...
		// 2. Java 11 버전부터 문자 스트림을 사용하는 방법:
...
//					break;
//				}
//				System.out.println((char) read); // 읽은 1글자를 콘솔에 출력
