 ...
 * 		|__ Exception
 * 			|__ RuntimeException, ...
 * 				|__ Arithmetic(산수)Exception, NullPointerException, ArrayIndexOutOfBoundsException, ...
 * 
 * - catch 블록이 여러개일 떄는 하위 타입의 에외들을 먼저 catch하고, 상위 타입의 예외들은 나중에 catch해야 함.
 */
...
public class ExceptionMain02 {
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("y는 0이 될 수 없");
