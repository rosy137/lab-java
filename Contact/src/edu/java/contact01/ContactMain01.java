...
public class ContactMain01 {
	...
	public static void main(String[] args) {
		...
		ContactMain01 app = new ContactMain01(); // static이 아닌 메서드들을 사용하기 위해 !참조 변수! 생성.		
		boolean run = true;
		while (run) {
			// 메인 메뉴 보여주기
			// 메인 메뉴에서 선택된 값
			...
			case 0: // 종료
				run = false;
				break;
			case 1: // 새 연락처 저장 (배열의 최댓값을 넘기면 안됨, 배열에 순서대로 저장되어야함.
			...
			case 3: // 배열의 인덱스로 검색하기
				...
				break;
			case 4: // 연락처의 이름이나 전화번호, 이메일 정보를 수정하기
				app.updateContactByIndex();
				break;
			case 5: // 배열의 인덱스로 연락처 삭제
...
//		if (count < MAX_LENGTH) { //
		...
		Contact c = new Contact(count+1, name, phone, email);
