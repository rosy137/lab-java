...
//	6. private 메서드: body가 구현된 private 메서드. Java 9 버전 부터 가능.
...
interface Test {
	...
	default void defaultMethod() {
		...
		privateStaticMethod();
		privateInstanceMethod(); // 디폴트 메서드에서 사용하기 위한 메서드
	}
...
public class InterfaceMain02 {
	...
	public static void main(String[] args) {
		...
		t.defaultMethod();  // 인터페이스에서 기본(default)으로 구현되어 있는 메서드. // 아이콘에서 D가 붙어있으면 구현되어 있다는 뜻.
